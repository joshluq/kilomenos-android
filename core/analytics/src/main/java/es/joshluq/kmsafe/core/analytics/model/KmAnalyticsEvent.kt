 ...
 */
sealed interface KmAnalyticsEvent {
    val name: String
    val properties: Map<String, Any> get() = emptyMap()

    // 1. Auth & Identity Funnel
    sealed interface Auth : KmAnalyticsEvent {
    ...
    sealed interface Onboarding : KmAnalyticsEvent {
    ...
    sealed interface Overview : KmAnalyticsEvent {
    ...
    sealed interface Tracking : KmAnalyticsEvent {
    ...
    sealed interface Monetization : KmAnalyticsEvent {
    ...
    // 6. Expenses & Stations
    sealed interface Expenses : KmAnalyticsEvent {
    ...
    sealed interface Projection : KmAnalyticsEvent {
    ...
    // 8. History & Audit
    sealed interface History : KmAnalyticsEvent {
    ...
    // 9. Profile & Churn
    sealed interface Profile : KmAnalyticsEvent {
    ...
    // 10. Fleet
    sealed interface Fleet : KmAnalyticsEvent {
