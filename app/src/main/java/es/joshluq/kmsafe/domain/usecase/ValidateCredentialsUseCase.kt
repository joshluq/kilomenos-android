...
import es.joshluq.kmsafe.di.EmailValidator
import es.joshluq.kmsafe.di.PasswordValidator
...
class ValidateCredentialsUseCase @Inject constructor(
    @param:EmailValidator private val emailValidator: @JvmSuppressWildcards Validator<String>,
    @param:PasswordValidator private val passwordValidator: @JvmSuppressWildcards Validator<String>
